...
@interface SendScreenViewController ()
{
    NSInteger btnIndex;
    UIButton * _seleteBtn;
}
...
@implementation SendScreenViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    btnIndex = self.order_id;
    [self createUI];
}
- (void)createUI{
 ...
 */
- (void)confirmClick{
    [self.delegate screenTime:btnIndex];
    [self exitClick];
}
/**
 时间排序
