...
@interface PrecelScreenViewController ()<LMJDropdownMenuDataSource,LMJDropdownMenuDelegate>
{
...
@implementation PrecelScreenViewController
...
- (void)viewDidLoad {
    ...
    if (listIndex == 0) {
        _menu2OptionTitles = @[@"　全　部　",@"发货待审核",@"待仓库确认",@"待支付运费",@"已付待发出"];
    }else if (listIndex == 1){
        _menu2OptionTitles = @[@"　全　部　",@"仓库已发货",@"待支付关税",@"确认退回仓",@"已退回到仓"];
    }else{
        _menu2OptionTitles = @[@"　全　部　",@"包裹已收货",@"包裹已转单"];
    }
