...
#import "HTPayCell3.h"
@interface HTPayCell3()<UITextFieldDelegate>
...
- (void)bankNumClick:(UITextField *)textField{
    [self.delegate creditCardBankNum:textField.text];
}
- (void)idNumClick:(UITextField *)textField{
    [self.delegate creditCardIdNum:textField.text];
}
- (void)mobileNumClick:(UITextField *)textField{
    [self.delegate creditCardMobileNum:textField.text];
}
- (void)codeTextClick:(UITextField *)textField{
    [self.delegate creditCardCodeNum:textField.text];
}
- (void)nameClick:(UITextField *)textField{
    [self.delegate creditCardName:textField.text];
}
- (void)validClick:(UITextField *)textField{
    [self.delegate creditCardValidity:textField.text];
}
- (void)safeClick:(UITextField *)textField{
    [self.delegate creditCardSafetyCode:textField.text];
}
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    [self.delegate creditCardseleteBankName];
    return NO;
}
