//
//  InfomationThreeViewController.m
//  TakeThings-iOS
//
...
@interface InfomationThreeViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger pageNum;
}
...
@implementation InfomationThreeViewController
...
- (void)requestNoticeData{
    NSDictionary * dic = @{@"type":@"0",@"page":[NSString stringWithFormat:@"%ld",(long)pageNum]};
