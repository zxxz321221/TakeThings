...
@interface PatViewController ()<UITableViewDelegate,UITableViewDataSource,PatCellDelegate,PremiumViewDelegate,HackViewDelegate,NoDataDelegate>
{
...
//    NSLog(@"geshu  %d",self.listArray.count);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    NSString * cellId = [NSString stringWithFormat:@"patCell%ld",(long)indexPath.row];
...
- (void)updatePlace:(NSDictionary *)dic{
    ...
    NSDictionary *params = @{@"agent":wtdId,@"customer":userInfo[@"member_id"],@"maxpirce":dic[@"place"],@"type":dic[@"type"],@"area":@"b",@"zplp":@"",@"shlp":@""};
        NSLog(@"%@",params);
...
- (void)cancelCase{
    NSDictionary * userInfo = [[NSUserDefaults standardUserDefaults]objectForKey:@"userInfo"];
    [self.aAnimation startAround];
    NSDictionary *params = @{@"agent":wtdId,@"customer":userInfo[@"member_id"],@"area":@"b"};
