...
@interface BidprocViewController ()<UITableViewDelegate,UITableViewDataSource,BidprocCellDelegate,NoDataDelegate>
{
...
@implementation BidprocViewController
...
- (void)requestOrderlist:(NSInteger )page{
    ...
    NSDictionary * dic = @{@"customer":userInfo[@"member_id"],@"status":@"storage",@"page":[NSString stringWithFormat:@"%ld",(long)page]};
    [GZMrequest getWithURLString:[GZMUrl get_ordermanager_url] parameters:dic success:^(NSDictionary *data) {
        NSLog(@"案件处理-得标处理中%@",data);
