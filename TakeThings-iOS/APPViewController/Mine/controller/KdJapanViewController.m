...
@interface KdJapanViewController ()<WKUIDelegate,WKNavigationDelegate>
@property (nonatomic , strong) WKWebView * wkWebView;
@property (nonatomic, strong) UIProgressView *progressView;

@end

@implementation KdJapanViewController
...
- (WKWebView *)wkWebView{
    if (!_wkWebView) {
        ...
        if (self.kd_url) {
            ...
            str = @"var translateDiv = document.createElement('div');\n"
...
//        self.kd_id = @"CI175276815JP";//测试用id
        if (self.kd_url) {
             [_wkWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://m.kuaidi100.com/result.jsp?nu=%@&com=ucs",self.kd_id]]]];
        }else{
