//
//  BidBeforePaymentViewController.m
//  TakeThings-iOS
//
...
@interface BidBeforePaymentViewController ()<UIScrollViewDelegate>
{
...
@implementation BidBeforePaymentViewController
...
- (void)viewDidLoad {
    ...
    [self.navigationItem setTitle:@"直接消费案件"];
...
- (void)setupChildViewController {
    ...
    PatViewController *oneVC = [[PatViewController alloc] init];
    [self addChildViewController:oneVC];
    
    BidViewController *twoVC = [[BidViewController alloc] init];
    [self addChildViewController:twoVC];
    
    NotBidViewController * sVC = [[NotBidViewController alloc]init];
