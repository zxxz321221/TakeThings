...
@interface CashFailure()
@property (nonatomic , strong) UIView * backView;
@property (nonatomic , strong) UIImageView * imageView;
@property (nonatomic , strong) UILabel * successL;
@property (nonatomic , strong) UIButton * confirm;
@end
@implementation CashFailure

+(instancetype)setCashFailure:(UIView *)view{
    CashFailure * cashFailuer = [[CashFailure alloc]initWithFrame:view.frame];
    [view addSubview:cashFailuer];
    return cashFailuer;
}
...
- (UIButton *)confirm{
    if (!_confirm) {
        ...
        [_confirm setTitle:@"返回" forState:UIControlStateNormal];
