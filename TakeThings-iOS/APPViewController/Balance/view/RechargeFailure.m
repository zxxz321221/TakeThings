...
@interface RechargeFailure()
@property (nonatomic , strong) UIView * backView;
@property (nonatomic , strong) UIImageView * imageView;
@property (nonatomic , strong) UILabel * successL;
@property (nonatomic , strong) UIButton * confirm;
@end
@implementation RechargeFailure


+(instancetype)setRechrgeFailure:(UIView *)view{
    RechargeFailure * rechargeSucc = [[RechargeFailure alloc]initWithFrame:view.frame];
...
- (UIImageView *)imageView{
    if (!_imageView) {
        ...
        _imageView.image = [UIImage imageNamed:@"提现失败"];
    }
    return _imageView;
}
- (UILabel *)successL{
...
- (UIButton *)confirm{
    if (!_confirm) {
        ...
        [_confirm setTitle:@"重新充值" forState:UIControlStateNormal];
