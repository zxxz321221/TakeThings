...
@interface ClassPageViewController ()<UITableViewDelegate, UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,CollectionViewHeaderDelegate>
...
//    NSLog(@"分组%@",self.rightArr[indexPath.section]);
//    NSLog(@"单元格%@",self.rightArr[indexPath.section][@"son_category"][indexPath.row]);
