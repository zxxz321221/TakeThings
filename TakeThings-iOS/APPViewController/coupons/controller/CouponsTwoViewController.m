...
@interface CouponsTwoViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation CouponsTwoViewController
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel * topL = [[UILabel alloc]initWithFrame:CGRectMake([Unity countcoordinatesW:10], [Unity countcoordinatesH:10], imageView1.width-[Unity countcoordinatesW:20], [Unity countcoordinatesH:15])];
    topL.text = @"投标编号:CD32114/fds01384";
    topL.textColor = LabelColor6;
    topL.font = [UIFont systemFontOfSize:FontSize(12)];
    [imageView1 addSubview:topL];
    
    UILabel * titleL = [[UILabel alloc]initWithFrame:CGRectMake([Unity countcoordinatesW:10], topL.bottom+[Unity countcoordinatesH:10], 100, [Unity countcoordinatesH:15])];
    titleL.text = @"代工费";
    titleL.textColor = LabelColor9;
    titleL.font = [UIFont systemFontOfSize:FontSize(16)];
    [imageView1 addSubview:titleL];
    
    UILabel * timeL = [[UILabel alloc]initWithFrame:CGRectMake([Unity countcoordinatesW:10], titleL.bottom, [Unity countcoordinatesW:125], [Unity countcoordinatesH:15])];
    timeL.text = @"2019.05.02 11:33:55";
...
- (void)headerView:(UITapGestureRecognizer *)tapGesture{
    ...
    NSString * str = [NSString stringWithFormat:@"%ld",tapGesture.view.tag];
    if ([dic[str]isEqualToString:@"0"]) {
