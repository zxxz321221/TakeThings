...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self == [super initWithFrame:frame]) {
        ...
        [self.readBtn setImage:[UIImage imageNamed:@"没选"] forState:UIControlStateNormal];
        [self.readBtn setImage:[UIImage imageNamed:@"read"] forState:UIControlStateSelected];
