...
+ (instancetype)defaultConfiguration {
    return [CWLateralSlideConfiguration configurationWithDistance:kCWSCREENWIDTH maskAlpha:0.4 scaleY:1.0 direction:CWDrawerTransitionFromLeft backImage:nil];
}
